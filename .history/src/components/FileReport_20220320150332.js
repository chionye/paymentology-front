        ...
        <table className="w-full table-auto border-collapse border-gray-300 text-sm">
            <thead>
                <tr className="text-left">
                    <th className="font-semibold text-base border border-gray-300 px-2" colSpan={3} >{props.fileName}</th>
                </tr>
            ...
            <tbody>
                <tr className='odd:bg-white even:bg-stone-100 hover:bg-white hover:text-blue hover:font-medium'>
